...
export const metadata = {
  ...
  description: 'Documentation complète de l\'API d\'alertes pour accéder aux perturbations du réseau de transport en commun de Montpellier',
  keywords: 'API, transport, Montpellier, alertes, documentation, tramway, bus',
  openGraph: {
    title: 'API d\'alertes de transport Montpellier',
    description: 'Accédez aux données d\'alertes du réseau de transport en commun de Montpellier',
    url: 'https://x.notif.tam.vercel.app/',
    siteName: 'Alertes Transport Montpellier',
    images: [
      {
        url: '/api-doc-preview.jpg',
        width: 1200,
        height: 630,
